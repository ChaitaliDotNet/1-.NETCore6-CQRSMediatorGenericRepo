...
namespace TCCS.WebAPI.Tests.Controller
{
    public class EmployeeControllerTest
    {
        ...
        public async Task AddEmployeeAsync_ReturnOkResult()
        {
            ...
            { Id = 1, Name = "Test", EmailId = "Test", Gender = "Male", MobileNumber = "", Salary = 232344 };
        ...
        private List<EmployeeModel> GetEmplopyeeList()
        {
            ...
            {
                new EmployeeModel{Id=1,Name="Test",EmailId="Test",Gender="Male",MobileNumber="",Salary=232344}
            };
            return list;
        }
