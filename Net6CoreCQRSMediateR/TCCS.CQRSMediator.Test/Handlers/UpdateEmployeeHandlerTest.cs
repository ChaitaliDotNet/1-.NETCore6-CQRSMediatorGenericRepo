...
namespace TCCS.CQRSMediator.Test.Handlers
{
    public class UpdateEmployeeHandlerTest
    {
        ...
        {
            var employee = new Employee() { Id = 1, Name = "Test", EmailId = "Test", Gender = "Male", MobileNumber = "", Salary = 232344 };
            ...
            var result = await handler.Handle(new UpdateEmployeeCommand(1,"test", "test", "male", "123344", 10000), default(CancellationToken));
